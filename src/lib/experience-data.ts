...
export const experiences: Experience[] = [
	...
	},
	{
		...
		description: {
			en: [
				"I teach classes to more than 200 students in web and backend technologies such as JavaScript, HTML, CSS, React.js, Next.js, Angular, Java, Spring Boot, Python, FastAPI at the Tecsup CodiGo bootcamp.",
			...
			es: [
				"Enseño clases a más de 200 estudiantes en tecnologías web y backend como JavaScript, HTML, CSS, React.js, Next.js, Angular, Java, Spring Boot, Python, FastAPI en el bootcamp CodiGo de Tecsup.",
	...
	},
	{
		...
		description: {
			en: [
				"Implemented custom style libraries in React.js and Angular for Scotiabank application development.",
				"I led the migration towards a modern application based on React.js with micro frontends.",
			...
			es: [
				"Implementé librerías de estilos personalizadas en React.js y Angular para el desarrollo de aplicaciones de Scotiabank.",
				"Lideré la migración hacia una aplicación moderna basada en React.js con micro frontends.",
