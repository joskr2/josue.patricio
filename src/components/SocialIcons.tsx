...
export function XIcon(props: Readonly<React.ComponentPropsWithoutRef<'svg'>>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
// GitHub icon as custom SVG (Lucide doesn't include it)
...
// LinkedIn icon as custom SVG (Lucide doesn't include it)
...
export function LocationIcon(
  ...
  return <MapPin aria-hidden="true" {...props} />
}
