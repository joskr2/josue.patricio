          ...
          <Disclosure>
            {({ open }) => (
              <>
                ...
                <DisclosurePanel className="px-4 pt-4 pb-2 text-sm text-zinc-600 md:hidden dark:text-zinc-400">
              ...
              <>
                ...
                <div className="mb-8 hidden md:block">
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <MetricsCard
                      title="Load Time"
                      value={project.metrics.loadTime}
                    />
                    <MetricsCard
                      title="API Response"
                      value={project.metrics.apiResponse}
                    />
                  </div>
                </div>
